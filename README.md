...
Откройте в Chrome или Edge: **<https://advogr2022-max.github.io/inkmetrics/flash-web/>**
(интернет нужен только чтобы открыть страницу — дальше страница работает с прибором сама).
...
> командной строки). Если у вас так же — прошивайте комплектом из раздела выше: он как раз переведён
> на работу без этих линий и на этой плате проверен.
