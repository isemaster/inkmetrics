...
(агент молчит); ниже температура видеокарты крупными цифрами, проценты CPU / RAM / DISK,
аптайм ПК и температура/влажность самого прибора. На SETUP — адрес веб-кабинета
(192.168.7.1), поворот экрана, режим диска, цель пинга и версия прошивки.

> Прошивка 0.5.0-idf. Плата Waveshare ESP32-S3-ePaper-1.54 (8 МБ флеша).
"""
