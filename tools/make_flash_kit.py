...
2. Больше ничего: ни ESP-IDF, ни Arduino IDE, ни исходников. Всё нужное — в папке idf.
...
Если порт вообще не открывается (esptool пишет «порт занят» или «устройство не работает»)
— отключите USB и подключите снова: загрузчик ESP32-S3 иногда укладывает свой порт, если его
потревожить за линии DTR/RTS. Поэтому обе команды в flash.bat идут без их дёргания.
